...
<head>
    ...
    {{--<link href="{{asset('lte/ionicons.min.css')}}" rel="stylesheet" type="text/css" />--}}
    <link href="{{asset('lte/plugins/datatables/dataTables.bootstrap.css')}}" rel="stylesheet" type="text/css" />
...
@yield('js')
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="{{asset('lte/plugins/jQueryUI/jquery-ui.min.js')}}" type="text/javascript"></script>
    ...
    <!-- FastClick -->
    <script src="{{asset('lte/plugins/fastclick/fastclick.min.js')}}" type="text/javascript"></script>
    <!-- AdminLTE App -->
    <script src="{{asset('lte/dist/js/app.min.js')}}" type="text/javascript"></script>
    <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
    <script src="{{asset('lte/dist/js/pages/dashboard.js')}}" type="text/javascript"></script>
